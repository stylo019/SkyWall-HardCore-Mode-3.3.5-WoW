...
local function OnCanSendMail(event, player, receiverGuid, mailbox, subject, body, money, cod, item)
    local receiver = GetPlayerByGUID(receiverGuid)
        if player:HasItem(666, 1) or (receiver and receiver:HasItem(666, 1)) then
            player:SendBroadcastMessage("|cffffd000 Hardcore Mode is detected. You are not authorized to perform this action.")
            return false
        end
    return true
end
...
local Mailboxes = {32349, 140908, 142075, 142089, 142093, 142094, 142095, 142102, 142103, 142109, 142110, 142111, 142117, 142119, 143981, 143982,
    ...
    185477, 185965, 186230, 186435, 186506, 186629, 186687, 187113, 187260, 187268, 187316, 187322, 188123, 188132, 188241, 188256, 188355, 188486, 
    188531, 188534, 188541, 188604, 188618, 188682, 188710, 189328, 189329, 189969, 190914, 190915, 191228, 191521, 191832, 191946, 191947, 191948, 
    191949, 191950, 191951, 191952, 191953, 191954, 191955, 191956, 191957, 192952, 193043, 193044, 193045, 193071, 193791, 193972, 194016, 194027, 
    194147, 194492, 194788, 195218, 195219, 195467, 195468, 195528, 195529, 195530, 195554, 195555, 195556, 195557, 195558, 195559, 195560, 195561, 
